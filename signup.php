...
<html lang="en">
  ...
  <div class="form-label-group">
    <input type="text" id="namdep" class="form-control" placeholder="FirstName" required autofocus>
    <label for="namdep">FristName</label>
  </div>  
  <div class="form-label-group">
    <input type="text" id="nambel" class="form-control" placeholder="LastName" >
    <label for="nambel">LastName</label>
  </div>
  <div class="form-label-group">
